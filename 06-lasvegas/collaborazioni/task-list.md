# Task List — Collaborazioni LasVegas
> Aggiornato: 2026-07-12 — tutti i task aperti spostati a **fine mese (settimana 27-31/07)** su indicazione di Alberto (ferie 14-22/07, al rientro priorità Softswiss).
...
## MESSAGGI EDUCATIVI GIOCATORE SOSTENIBILE — cadenza di revisione

> Cadenza a calendario, non legata al comportamento del singolo giocatore. Vedi `../strategia/messaggi-educativi-giocatore-sostenibile.md` per i testi e `../strategia/piano-conversione-bonus-abuser.md` per i trigger di dettaglio.
...
- [x] **Video HeyGen Messaggio 0** — prodotto e condiviso (01/08/2026), script in `../strategia/video-script/script-messaggio-0.md`
- [ ] **Revisione settimanale (ogni lunedì)** — controlla rollover chiusi nella settimana precedente → invia Messaggio 1 dove pertinente
- [ ] **Revisione settimanale (ogni lunedì, stesso giro)** — controlla giocatori inattivi da 3+ giorni post-bonus → invia Messaggio 2 dove pertinente
- [ ] **Revisione mensile (ultimo giorno del mese)** — controlla chi ha superato la soglia cashback 2.000€ → invia Messaggio 3 dove pertinente
- [ ] **Revisione quindicinale (ogni due lunedì)** — controlla nuovi ingressi con conto GoldBet preesistente → invia Messaggio 4 dove pertinente
- [ ] **Revisione mensile (ultimo giorno del mese)** — controlla i tier alti (1.500€+) per pattern a picchi, solo profili "Value player" → invia Messaggio 5 dove pertinente, mai su profili "Rischio RG"
