...
| ~~11/09~~ → **25/09** | ~~Ven~~ Ven | Post testo | EN | Un aggregatore che funziona in un mercato non basta per il prossimo (Atto 2) | No | 23/09 (Mer) | [~] **ALB-126** — **draft pronto (24/09)**, `post-2026-09-25-aggregator-one-market-not-next.md` + `grafiche/2026-09-25-aggregator-catalogue-cover.png`. Accompagna N7. In attesa di conferma di Alberto |
| **25/09** (nuova, 01/09/2026 — mancante qui, aggiunta l'08/09) | Ven | **Newsletter N7 — The Betting Edge** | IT | Scegliere un game aggregator per più mercati regolamentati: perché la scelta cambia da IT a DE a BE | No | 23/09 (Mer) | [~] **ALB-127** — **draft pronto (24/09)**, `newsletter-2026-09-25-n7-game-aggregator-multi-mercato.md` + copertina `grafiche/alberto-lattuada-newsletter-n7-game-aggregator-multi-mercato-cover.png`. Solo fonti normative pubbliche, nessun riferimento a Softswiss (vincolo del 24/09). Restano: conferma, footer bio, Pangram |
| ~~14/09~~ → **28/09** | ~~Lun~~ Lun | Post testo | EN | Dopo la firma in un nuovo mercato, il vero lavoro comincia (Atto 3) | No | 24/09 (Gio) | [~] **ALB-128** — **draft pronto (24/09)**, `post-2026-09-28-after-signing-release-pipeline.md` + `grafiche/2026-09-28-release-pipeline-cover.png`. Rimanda a N8 (02/10). In attesa di conferma di Alberto |
