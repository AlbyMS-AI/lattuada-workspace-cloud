...
| ~~07/08~~ → **10/08** | ~~Ven~~ Lun | Post testo | EN | Tony Bloom non scommette: la distinzione che cambia tutto | No | **subito** (era 05/08) | [ ] Da sviluppare — **recuperato il 07/08**, apre la settimana di recupero |
| ~~05/08~~ → **12/08** | ~~Mer~~ Mer | Carosello | EN | Portfolio giochi: perché più titoli non significa più revenue (framework PAS, spunto Lezione 8 MLR) | Sì — carosello PDF (workflow Canva/NotebookLM) | 10/08 (Lun) | [ ] Da sviluppare — **recuperato il 07/08**. Unica eccezione al ritmo ridotto in questo blocco. ⚠️ Verificare su fonte pubblica la cifra "mercato dominato da 6 titoli" (detta a voce in sessione) prima di scriverlo, non citarla come certa |
...
6. **Subito (weekend 08-09/08):** sviluppare il post EN Tony Bloom per Lun 10/08 — è il pezzo più in ritardo e apre la settimana di recupero.
7. **Lun 10/08 (creare entro):** carosello "Portfolio giochi" (framework PAS) per Mer 12/08 — verificare prima la cifra "6 titoli" su fonte pubblica.
8. **Mer 12/08 (creare entro):** chiudere newsletter N2 (AGCOM) + carosello "Claude proposta commerciale IT" per Ven 14/08 — due pezzi lo stesso giorno, chiudono Blocco 2. N2 è già fact-checked e umanizzata, resta solo la revisione finale di Alberto.
9. **Entro Ven 14/08 (decisione, non produzione):** N3 resta al 21/08 a 7 giorni da N2, oppure slitta al 28/08 e si scollega dal carosello certificazione? Da sciogliere prima di programmare N2.
