...
| ~~17/08~~ → **31/08** | ~~Lun~~ Lun | Sondaggio | EN | Cost visibility sull'integrazione giochi (angolo scelto al posto del confronto stack, aggancia post+N4 del 04/09) | No | ~~27/08 (Gio)~~ → **29/08 (Sab, recupero weekend)** | [x] Salvato — `sondaggio-2026-08-31-costo-integrazioni.md`. Solo pubblico, nessun DM Sales Navigator. Da schedulare da Alberto per lunedì 31/08 |
...
| 2 | Blocco 4 (EN, dal 31/08) | Rischio compliance su più integrazioni dirette in parallelo (estensione EN/multi-mercato del pattern certificazione, Batch 1) | Marco CDO-GM, sotto-selezione BE/CZ/DE/IE (pool 189, esclusi contatti Batch 1) | 20-30 | Post "3 hidden costs" + N4, 04/09 | ~~27/08 (Gio)~~ → **29/08 (Sab, recupero weekend)** | [~] Tema/bacino definiti, testo in `content-strategy/outreach-domanda-ricerca.md` — da approvare prima di selezione nominativi e invio. Procede in parallelo al Batch 1 (non in sequenza) |
...
**Nota (29/08):** verificato lo stato reale — `buyer-voice.md` e `lead-tracker-outbound.md` sono fermi al 18/08 (i 6 contatti Batch 1 restano `inviato`, zero risposte, nessuna riga nuova: niente di nuovo da validare lì). Il blocco vero è `analytics-performance.md`, fermo al 14/08 con un export che non conteneva salvataggi/visite profilo/connessioni — i KPI reali richiesti dal checkpoint. **Serve un nuovo export di Alberto** (AnalisiAggregate aggiornato + dettaglio per singolo post se disponibile) prima di poter chiudere questo checkpoint con dati veri invece che con un proxy. Nessun impatto nel frattempo: Blocco 5 apre solo il 14/09.
