...
| ~~28/08~~ → ~~11/09~~ → **14/09** | ~~Ven~~ Lun | Carosello | EN | Checklist compliance per un nuovo mercato (chiude Blocco 4) | Sì — testo approvato, check Codex applicato, grafica prodotta con pipeline locale HTML dopo 2 tentativi NotebookLM scartati (testo non selezionabile): `grafiche/Market entry compliance checklist iGaming licensing Alberto Lattuada.pdf` | fatto | [x] **ALB-102** — testo e PDF pronti, `carosello-2026-09-14-checklist-compliance-nuovo-mercato.md`, slittato dal weekend (deciso 11/09/2026). Pronto per la pubblicazione (resta il check Astra). In coppia con N5 (**ALB-103**) |
| ~~11/09~~ → **14/09** | ~~Ven~~ Lun | **Newsletter N5 — The Betting Edge** | IT | Checklist compliance iGaming: cosa verificare prima di entrare in un nuovo mercato | Sì — testo approvato da Alberto, check Codex applicato; copertina prodotta e renderizzata: `grafiche/alberto-lattuada-newsletter-n5-checklist-compliance-cover.png` | fatto | [x] **ALB-103** — testo e copertina pronti, `newsletter-2026-09-14-n5-checklist-compliance-nuovo-mercato.md`, slittata dal weekend (deciso 11/09/2026). Post di accompagnamento in `post-2026-09-14-newsletter-n5-accompagnamento.md`. Pronta per la pubblicazione (resta il check Astra, vedi nota in cima al file). Prima edizione a cadenza settimanale |
...
| Pubblica | Giorno | Formato | Lingua | Contenuto | Grafica | Creare entro | Stato |
|---|---|---|---|---|---|---|---|
| ~~31/08~~ → ~~14/09~~ → **16/09** | ~~Lun~~ Mer | Post testo | IT | Esports betting +91% e gli operatori ADM non ci sono | No | **14/09 (Lun)** (era 10/09, slittato: lunedì occupato dal recupero Blocco 4) | [ ] **ALB-122** — da sviluppare, slittato al mercoledì (deciso 11/09/2026), eccezione una tantum al taglio del mercoledì |
