...
| ~~11/09~~ → **25/09** | ~~Ven~~ Ven | Post testo | EN | Un aggregatore che funziona in un mercato non basta per il prossimo (Atto 2) | No | 23/09 (Mer) | [~] **ALB-126** — **cambio di tiro 25/09**: niente aggregatore, competenza regolatoria. `post-2026-09-25-licence-where-not-what.md` + `grafiche/2026-09-25-licence-where-not-what-cover.png`. Accompagna N7, esce dopo di lei |
| **25/09** (nuova, 01/09/2026 — mancante qui, aggiunta l'08/09) | Ven | **Newsletter N7 — The Betting Edge** | IT | Scegliere un game aggregator per più mercati regolamentati: perché la scelta cambia da IT a DE a BE | No | 23/09 (Mer) | [~] **ALB-127** — **cambio di tiro 25/09**: "Mercati regolamentati iGaming: cosa cambia davvero tra Italia, Germania e Belgio" (licenza vs offerta reale, quattro livelli). `newsletter-2026-09-25-n7-mercati-regolamentati-it-de-be.md` + `grafiche/alberto-lattuada-newsletter-n7-mercati-regolamentati-cover.png`. Fatti già passati dal fact-check esterno del 24/09. Restano: footer bio, Pangram, pubblicazione a metà giornata |
| ~~14/09~~ → **28/09** | ~~Lun~~ Lun | Post testo | EN | Dopo la firma in un nuovo mercato, il vero lavoro comincia (Atto 3) | No | 24/09 (Gio) | [~] **ALB-128** — **cambio di tiro 25/09**: "After the licence, the rules keep moving" (deroga GGL, condizioni, scadenze). `post-2026-09-28-rules-keep-moving.md` + `grafiche/2026-09-28-rules-keep-moving-cover.png`. Rimanda a N8 |
