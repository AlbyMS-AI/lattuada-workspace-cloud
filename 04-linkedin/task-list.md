...
| Pubblica | Giorno | Formato | Lingua | Contenuto | Grafica | Creare entro | Stato |
|---|---|---|---|---|---|---|---|
| ~~31/08~~ → ~~14/09~~ → ~~16/09~~ → **18/09** | ~~Lun~~ ~~Mer~~ Ven | Post testo | IT | Esports betting +91% e gli operatori ADM non ci sono | No | ~~14/09 (Lun)~~ → **17/09 (recupero /agenda)** | [ ] **ALB-122** — mai prodotto per il 16/09, accorpato agli altri due pezzi di Blocco 5 il 18/09 per chiudere il blocco senza altri slittamenti (deciso via `/agenda` il 17/09/2026) |
| ~~04/09~~ → **18/09** | ~~Ven~~ Ven | Carosello | IT | Come integrare esports in un'offerta già strutturata (Atto 3) | Sì — carosello PDF (workflow Canva/NotebookLM) | ~~16/09 (Mer)~~ → **17/09 (recupero /agenda)** | [ ] **ALB-123** — da sviluppare, scadenza creazione slittata dal 16 al 17/09 (mai prodotto in tempo) |
| ~~04/09~~ → **18/09** | ~~Ven~~ Ven | **Newsletter N6 — The Betting Edge** | IT | Esports betting: il giocatore non è un bettor tradizionale (rinumerata da N4 il 13/07, poi N5→N6 il 01/09 per la cadenza settimanale — corretto qui l'08/09, era rimasta a "N5") | No (testo + immagini inline con tag alt) | ~~16/09 (Mer)~~ → **17/09 (recupero /agenda)** | [ ] **ALB-124** — da sviluppare, scadenza creazione slittata dal 16 al 17/09 (mai prodotto in tempo) |
