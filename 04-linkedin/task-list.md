...
| ~~28/08~~ → ~~11/09~~ → **14/09** | ~~Ven~~ Lun | Carosello | EN | Checklist compliance per un nuovo mercato (chiude Blocco 4) | Sì — testo approvato da Alberto, check Codex applicato; brief NotebookLM pronto in `grafiche/inbox/carosello-checklist-compliance-notebooklm-brief.md`, generazione slide ancora da fare (manuale, utente) | fatto | [~] **ALB-102** — testo in `carosello-2026-09-14-checklist-compliance-nuovo-mercato.md`, slittato dal weekend (deciso 11/09/2026). Manca solo la generazione grafica via NotebookLM. In coppia con N5 (**ALB-103**) |
