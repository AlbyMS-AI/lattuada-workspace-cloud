...
| ~~07/08~~ → **21/08** | ~~Ven~~ Ven | Carosello | IT | Come verificare la certificazione di un provider | Sì — carosello PDF (workflow Canva/NotebookLM) | 19/08 (Mer) | [x] Testo 8 slide scritto (20/08) — `carosello-2026-08-21-certificazione-provider.md`. Manca solo produzione grafica Canva/NotebookLM |
| ~~07/08~~ → **21/08** | ~~Ven~~ Ven | **Newsletter N3 — The Betting Edge** | IT | Certificazione provider: guida tecnica per CDO | No (testo + immagini inline con tag alt) | 19/08 (Mer) | [x] Scritta e salvata (20/08) — `newsletter-2026-08-21-n3-certificazione-provider.md` + post di accompagnamento `post-2026-08-21-newsletter-n3-accompagnamento.md`. Manca revisione finale Alberto e link reale nel post |
