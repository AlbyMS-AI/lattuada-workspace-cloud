...
> **Settimana di recupero (07/08/2026):** i tre pezzi di Blocco 2 previsti per il 05/08 e il 07/08 non sono stati prodotti. Recuperati negli slot della settimana 10-14/08 — post Tony Bloom Lun 10/08, carosello Portfolio giochi Mer 12/08, newsletter N2 Ven 14/08 insieme al carosello Claude che chiude il blocco. **Il resto del calendario non si muove:** Blocco 3 apre regolarmente Lun 17/08, Blocco 4-6 e il checkpoint analytics di fine agosto restano dove sono. Resta da decidere la cadenza di N3 (vedi punto 9 in "Prossimi task").
...
> **Slittamento weekend (11/09/2026):** carosello EN + newsletter N5 IT di chiusura Blocco 4, previsti Ven 11/09, non sviluppati in tempo — pubblicarli avrebbe significato uscire sabato 12/09, contro la regola oraria B2B. Spostati a Lun 14/09. Il post di apertura Blocco 5 (Esports, già Lun 14/09) slitta al mercoledì 16/09, eccezione una tantum al taglio del mercoledì (stesso trattamento del 12/08). Nessuno slittamento a valle. Dettaglio in `piano-editoriale-2026.md`.
...
**Regola "creare entro":** contenuto di lunedì → creare entro il giovedì della settimana precedente; contenuto di mercoledì → creare entro il lunedì stesso; contenuto di venerdì → creare entro il mercoledì stesso.
...
|---|---|---|---|---|---|
| 01/07 | Mer | Sondaggio | EN | Retail vs online: dove scommetti? | [x] Pubblicato (case study Lezione 6 — 0 voti) |
| 03/07 | Ven | Grafica | EN | Dati maggio: narrativa del declino ribaltata | [x] Pubblicato |
| 06/07 | Lun | Post testo | EN | La ricevitoria come luogo di socialità | [x] Pubblicato |
| 07/07 | Mar | Post testo | EN | 350 skin sparite, 46 operatori rimasti | [x] Pubblicato — `post-2026-07-07-consolidamento-mercato-adm.md` |
| 09/07 | Gio | Grafica | IT | Infografica riordino ADM — prima/dopo | [x] Pubblicato — `post-2026-07-09-infografica-riordino-adm.md` (Canva) |
| 10/07 | Ven | Carosello | IT | 5 operatori ADM che crescono nel 2026 | [x] Pubblicato — `carosello-2026-07-10-operatori-adm-crescita.md` |
| 10/07 | Ven | **Newsletter N1 — The Betting Edge** | IT | Riordino licenze ADM — approfondimento | [x] Pubblicato — `newsletter-2026-07-10-n1-riordino-adm.md` |

---

## Ritmo ridotto — luglio, agosto e settembre (13/07 – 11/09)

**Ritmo ridotto esteso** (deciso 10/07, confermato ed esteso il 13/07, slittato 2 settimane il 14/07): 2 post/settimana per tutto il periodo, mercoledì (grafica) sempre saltato. Newsletter bisettimanale piena, senza salti: aggiunta un'edizione intermedia N3, di conseguenza N4/N5/N6 rinumerate (vedi righe sotto). Le grafiche saltate vanno in backlog (sotto).
**Ferie 14-22/07**: nessuna attività LinkedIn. Il sondaggio IT non è uscito prima della ferie — pubblica dopo, il 27/07 (vedi nota slittamento in alto).
...
| ~~31/07~~ → ~~14/08~~ | ~~Ven~~ | Carosello | EN | Claude per una proposta commerciale mercato IT regolamentato (Atto 3, anonimizzato) | Sì — carosello PDF (workflow Canva/NotebookLM) | 12/08 (Mer) | [x] **ALB-104 — chiusa 03/09** (decisione di Alberto: non si recupera). Nessun testo mai scritto |
| ~~03/08~~ → ~~17/08~~ | ~~Lun~~ | Post testo | IT | La contraffazione dei giochi cresce col mercato legale | No | 13/08 (Gio) | [x] **ALB-105 — chiusa 03/09** (decisione di Alberto: non si recupera). Nessun testo mai scritto |
...
| ~~21/08~~ → **04/09** | ~~Ven~~ Ven | Post testo (assorbe l'accompagnamento) | EN | I 3 costi nascosti che i CDO non pesano (Atto 3) | No | 02/09 (Mer) | [x] **ALB-100 — deciso 03/09**: questo post EN diventa l'unico accompagnamento di N4 (chiude già con "in this week's edition of The Betting Edge, in Italian"). Il vecchio accompagnamento IT generico è superato, non si pubblicano entrambi. Testo pronto in `post-2026-09-04-hidden-costs-integration.md` |
| ~~21/08~~ → **04/09** | ~~Ven~~ Ven | **Newsletter N4 — The Betting Edge** | IT | Il costo reale di un'integrazione multipla: cosa i CDO non vedono alla firma | Sì — copertina (foto + card, template N2) + 1 immagine inline | 02/09 (Mer) | [x] **ALB-99 — chiusa 03/09**, `newsletter-2026-09-04-n4-costo-integrazione-multipla.md` (1.183 parole). Accompagnamento superato (vedi riga ALB-100 sopra). Tesi: l'integrazione è una porta a senso unico. Copertina: `grafiche/alberto-lattuada-newsletter-n4-costo-integrazione-cover.png` (hook diverso dall'H1, vedi `feedback_grafiche_hook_diverso_da_titolo`). Immagine inline: `grafiche/alberto-lattuada-costo-integrazioni-game-aggregator.png` (via NotebookLM, brief in `grafiche/inbox/n4-confronto-integrazioni-notebooklm-brief.md`), confermata da Alberto — segnaposto nel testo già puntava al nome file corretto |
| ~~24/08~~ → **07/09** | ~~Lun~~ Lun | Post con immagine | EN | Catena di responsabilità partner/aggregatore nei 5 mercati EU (angolo scelto al posto del tema originale) | Sì — main image, catena Operator→Partner→Sub-provider | 03/09 (Gio) | [x] **ALB-101 — programmato (03/09)** per il 07/09, `post-2026-09-07-partner-liability-chain.md` + `grafiche/alberto-lattuada-partner-liability-chain-igaming.png` |
| ~~28/08~~ → ~~11/09~~ → **14/09** | ~~Ven~~ Lun | Carosello | EN | Checklist compliance per un nuovo mercato (chiude Blocco 4) | Sì — grafica prodotta con pipeline locale HTML dopo 2 tentativi NotebookLM scartati: `grafiche/Market entry compliance checklist iGaming licensing Alberto Lattuada.pdf` | fatto | [x] **ALB-102** — **Pubblicato (13/09, confermato da Alberto)**. Testo/PDF/caption in `carosello-2026-09-14-checklist-compliance-nuovo-mercato.md`. In coppia con N5 (**ALB-103**) |
| ~~11/09~~ → **14/09** | ~~Ven~~ Lun | **Newsletter N5 — The Betting Edge** | IT | Checklist compliance iGaming: cosa verificare prima di entrare in un nuovo mercato | Sì — copertina: `grafiche/alberto-lattuada-newsletter-n5-checklist-compliance-cover.png` | fatto | [x] **ALB-103** — **Pubblicata (13/09, confermato da Alberto)**, schedulata per lunedì 14/09 ore 11:00. Testo in `newsletter-2026-09-14-n5-checklist-compliance-nuovo-mercato.md`, post di accompagnamento in `post-2026-09-14-newsletter-n5-accompagnamento.md`. Chiude Blocco 4. Prima edizione a cadenza settimanale |
...
| 2 | Blocco 4 (EN, dal 31/08) | Rischio compliance su più integrazioni dirette in parallelo (estensione EN/multi-mercato del pattern certificazione, Batch 1) | Marco CDO-GM, sotto-selezione BE/CZ/DE/IE (pool 189, esclusi contatti Batch 1) | 20-30 | Post "3 hidden costs" + N4, 04/09 | ~~27/08 (Gio)~~ → ~~29/08~~ | [~] **In attesa (30/08) — decisione di Alberto**: non si invia ora, si aspetta prima di vedere come gira organicamente il sondaggio del 31/08. Tema/bacino/testo restano pronti in `content-strategy/outreach-domanda-ricerca.md`, selezione nominativi non ancora fatta (blocco: Sales Navigator è manuale, serve l'export/scorrimento di Alberto) |
...
## Checkpoint analytics — fine agosto (task trasversale, prima di Settembre)

**Nota (29-30/08):** verificato lo stato reale — `buyer-voice.md` e `lead-tracker-outbound.md` sono fermi al 18/08 (i 6 contatti Batch 1 restano `inviato`, zero risposte: niente di nuovo da validare lì).

**Chiuso il 30/08 con dati reali** — Alberto ha fornito l'export aggregato (15/08-28/08) e il dettaglio per-post (salvataggi/visite profilo/follower) sui due contenuti a maggior reach del periodo. Dettaglio completo in `analytics-performance.md`, sezioni "Finestra 15/08-28/08" e "Dettaglio per singolo post".

- [x] **Cadenza settembre**: crescita "a picchi" (1-2 contenuti trainano la maggioranza del reach in entrambe le finestre osservate), non da volume. **Decisione: restare a 2 post/settimana** anche a settembre (Blocco 5/6), mercoledì resta saltato. Nessun segnale nei dati che giustifichi tornare a 3/settimana.
- [x] **Buyer persona Marco/Giulia**: primo confronto reale disponibile. Paul Gauselmann (22/08, pubblico 35-45% gambling) converte visite profilo → follower al 43% (6/14); Tony Bloom (10/08, pubblico 24% finance/10% gambling) converte solo al 9% (2/22) ma genera più salvataggi in assoluto (4 vs 2) — reach ampio fuori target salva ma non fidelizza, reach più piccolo in target fidelizza meglio. Non conclusivo su Marco/Giulia nello specifico (nessuna risposta buyer-voice ancora arrivata), ma primo segnale utile: contenuti su figure/aziende di settore riconoscibili sembrano trattenere meglio l'audience gambling di temi "valore" astratti.

Resta aperto, non bloccante: dettaglio salvataggi/visite profilo non ancora pullato su Varenne, "Lo stallo non è neutrale", carosello certificazione provider, Portfolio giochi, Licensing collo di bottiglia — utile per un quadro più completo ma non necessario per le due decisioni sopra.
...
**Confermato dal checkpoint analytics (chiuso 30/08):** Blocco 5 e Blocco 6 restano a 2 post/settimana come i blocchi precedenti — nessun segnale nei dati che giustifichi tornare a 3/settimana. Mercoledì 16/09, 23/09 e 30/09 saltano, spostati in backlog grafiche sotto (stesso trattamento dei mercoledì saltati nei blocchi precedenti). Aggiornato 08/09/2026: la tabella era rimasta ferma alla versione "provvisoria" nonostante la decisione del 30/08 — corretto in fase di verifica task Linear. **Aggiornato 11/09/2026:** il mercoledì 16/09 è stato eccezionalmente riattivato per il recupero del post di apertura Blocco 5 (slittamento weekend su Blocco 4, vedi nota in testa al file) — 23/09 e 30/09 restano saltati.

| Pubblica | Giorno | Formato | Lingua | Contenuto | Grafica | Creare entro | Stato |
|---|---|---|---|---|---|---|---|
| ~~31/08~~ → ~~14/09~~ → ~~16/09~~ → ~~18/09~~ | ~~Lun~~ ~~Mer~~ ~~Ven~~ | Post testo | IT | Esports betting +91% e gli operatori ADM non ci sono | No | ~~14/09 (Lun)~~ → ~~17/09 (recupero /agenda)~~ | [ ] **ALB-122 — `[arretrato, era 18/09]`** (rinominata via `/agenda` il 21/09/2026): secondo slittamento consecutivo, mai prodotto. Decisione di Alberto necessaria (recuperare/riscrivere/chiudere) |
| ~~04/09~~ → ~~18/09~~ | ~~Ven~~ ~~Ven~~ | Carosello | IT | Come integrare esports in un'offerta già strutturata (Atto 3) | Sì — carosello PDF (workflow Canva/NotebookLM) | ~~16/09 (Mer)~~ → ~~17/09 (recupero /agenda)~~ | [ ] **ALB-123 — `[arretrato, era 18/09]`** (rinominata via `/agenda` il 21/09/2026): secondo slittamento consecutivo, mai prodotto. Decisione di Alberto necessaria |
| ~~04/09~~ → ~~18/09~~ | ~~Ven~~ ~~Ven~~ | **Newsletter N6 — The Betting Edge** | IT | Esports betting: il giocatore non è un bettor tradizionale (rinumerata da N4 il 13/07, poi N5→N6 il 01/09 per la cadenza settimanale — corretto qui l'08/09, era rimasta a "N5") | No (testo + immagini inline con tag alt) | ~~16/09 (Mer)~~ → ~~17/09 (recupero /agenda)~~ | [ ] **ALB-124 — `[arretrato, era 18/09]`** (rinominata via `/agenda` il 21/09/2026): secondo slittamento consecutivo, mai prodotto. Decisione di Alberto necessaria |
| ~~07/09~~ → **21/09** | ~~Lun~~ Lun | Post testo (era Sondaggio, cambiato nel piano il 01/09 — corretto qui l'08/09) | EN | Criterio che pesa di più nell'espansione in un nuovo mercato regolamentato (normativa locale / partner tecnologico già presente / tempo di certificazione / costo di ingresso) | No | ~~17/09 (Gio)~~ → **21/09 (recupero /agenda)** | [ ] **ALB-125** — da sviluppare oggi, pubblicazione prevista oggi stesso. Cambiato da sondaggio a post: nessun motore outbound attivo dietro, i due sondaggi EN senza DM di supporto (03/08, 31/08) sono rimasti sotto i 3 voti |
| ~~11/09~~ → **25/09** | ~~Ven~~ Ven | Post testo | EN | Un aggregatore che funziona in un mercato non basta per il prossimo (Atto 2) | No | 23/09 (Mer) | [x] **ALB-126** — **Pubblicato il 25/09** (confermato da Alberto). Cambio di tiro del 25/09: competenza regolatoria, niente aggregatore. `post-2026-09-25-licence-where-not-what.md` + `grafiche/2026-09-25-licence-where-not-what-cover.png` |
| **25/09** (nuova, 01/09/2026 — mancante qui, aggiunta l'08/09) | Ven | **Newsletter N7 — The Betting Edge** | IT | Scegliere un game aggregator per più mercati regolamentati: perché la scelta cambia da IT a DE a BE | No | 23/09 (Mer) | [x] **ALB-127** — **Pubblicata il 25/09** (confermato da Alberto). "Mercati regolamentati iGaming: cosa cambia davvero tra Italia, Germania e Belgio". `newsletter-2026-09-25-n7-mercati-regolamentati-it-de-be.md` + copertina `grafiche/alberto-lattuada-newsletter-n7-mercati-regolamentati-cover.png` + infografica inline `grafiche/alberto-lattuada-newsletter-n7-scheda-mercato-germania.png` + accompagnamento `post-2026-09-25-newsletter-n7-accompagnamento.md`. Firma senza qualifica, solo nome e rimando al profilo (decisione di Alberto) |
| ~~14/09~~ → **28/09** | ~~Lun~~ Lun | Post testo | EN | Dopo la firma in un nuovo mercato, il vero lavoro comincia (Atto 3) | No | 24/09 (Gio) | [x] **ALB-128** — **Programmato il 25/09 per lun 28/09** (confermato da Alberto). "After the licence, the rules keep moving". `post-2026-09-28-rules-keep-moving.md` + `grafiche/2026-09-28-rules-keep-moving-cover.png`. Rimanda a N8 |
...
## Backlog grafiche (posticipate dal ritmo ridotto)

Non si perdono: si producono con la pipeline workspace quando si libera uno slot o si torna a regime. Nomi file e tag alt SEO: tabella "Grafiche" in `piano-editoriale-2026.md`.

| Origine | Contenuto | Stato |
|---|---|---|
...
| 12/08 (Mer — era 29/07) | 5 usi concreti dell'AI nel processo BDM (EN) | [ ] In backlog — **spostato qui il 01/08**: era rimasto attivo per errore nel piano nonostante il taglio mercoledì. Il 07/08 lo slot del 12/08 è stato assegnato al recupero del carosello Portfolio giochi, quindi resta in backlog a maggior ragione |
...
| Confronto esports globale vs mercato ADM — **primo test video 9:16** (IT), nessuno slot fisso | [ ] In backlog — spostato qui l'08/09 in seguito alla conferma 2 post/settimana (checkpoint 30/08); il mercoledì 16/09 (unico slot disponibile) è stato riassegnato l'11/09/2026 al post di apertura Blocco 5 (recupero weekend) — il test video resta da schedulare al prossimo mercoledì libero |
...
5. ~~Lun 03/08: carosello "Portfolio giochi" per Mer 05/08~~ · ~~Mer 05/08: post Tony Bloom + newsletter N2 per il 07/08~~ — **nessuno dei tre prodotto.** Recuperati nella settimana 10-14/08 (decisione del 07/08), il resto del calendario non si muove.
6. ~~Subito (weekend 08-09/08): sviluppare il post EN Tony Bloom per Lun 10/08~~ — **fatto**, `post-2026-08-10-tony-bloom-liquidita.md`, pronto per pubblicazione.
7. ~~Lun 10/08 (creare entro): carosello "Portfolio giochi" (framework PAS) per Mer 12/08~~ — **testo fatto** (10/08), `carosello-2026-08-12-portfolio-giochi.md`. Cifra "6 titoli" non verificabile, sostituita da meccanismo anonimizzato. Resta impaginazione grafica (Canva/NotebookLM) e autocontrollo anti-AI EN.
8. ~~Mer 12/08 (creare entro): chiudere newsletter N2 (AGCOM) + carosello "Claude proposta commerciale IT" per Ven 14/08~~ — **N2 fatta**, revisione anti-AI completata il 13/08 (2 trattini lunghi e 1 doppione "Non è X. È Y." corretti nel corpo). Resta la conferma finale di Alberto prima della pubblicazione. Carosello "Claude proposta commerciale IT" ancora da sviluppare.
9. ~~Entro Ven 14/08 (decisione, non produzione): N3 resta al 21/08 a 7 giorni da N2, oppure slitta al 28/08?~~ — **deciso il 13/08: N3 resta al 21/08**, accettato lo strappo di 7 giorni una tantum.
10. **Lun 17/08:** Blocco 3 IT apre regolarmente — nessuno slittamento a valle del recupero.
...
Ogni volta che un contenuto viene sviluppato e salvato, spuntare la riga e collegare il file prodotto. Ogni volta che viene pubblicato, aggiornare lo stato da "Salvato" a "Pubblicato". Questa task list segue `piano-editoriale-2026.md`: se il piano cambia, aggiornare prima il piano e poi questa lista.
