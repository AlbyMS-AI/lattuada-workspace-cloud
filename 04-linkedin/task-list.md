...
| ~~28/08~~ → ~~11/09~~ → **14/09** | ~~Ven~~ Lun | Carosello | EN | Checklist compliance per un nuovo mercato (chiude Blocco 4) | Sì — testo pronto, grafica da produrre (Canva/NotebookLM) | fatto | [~] **ALB-102** — testo pronto in `carosello-2026-09-14-checklist-compliance-nuovo-mercato.md`, slittato dal weekend (deciso 11/09/2026). Manca grafica + conferma finale di Alberto. In coppia con N5 (**ALB-103**) |
| ~~11/09~~ → **14/09** | ~~Ven~~ Lun | **Newsletter N5 — The Betting Edge** | IT | Checklist compliance iGaming: cosa verificare prima di entrare in un nuovo mercato | Sì — copertina da produrre, testo pronto | fatto | [~] **ALB-103** — testo pronto in `newsletter-2026-09-14-n5-checklist-compliance-nuovo-mercato.md`, slittata dal weekend (deciso 11/09/2026). Manca copertina + conferma finale di Alberto. Prima edizione a cadenza settimanale |
